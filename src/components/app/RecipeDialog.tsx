...
import { CATEGORY_LABELS, CATEGORY_EMOJI } from "@/lib/menuUtils";
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="grid grid-cols-4 gap-2 text-center">
            <div className="rounded-xl bg-secondary p-2">
              ...
              <div className="text-[10px] text-muted-foreground">ккал взр.</div>
            </div>
            <div className="rounded-xl bg-secondary p-2">
              <div className="text-lg font-bold text-foreground">{recipe.nutrition.kcalChild}</div>
              <div className="text-[10px] text-muted-foreground">ккал реб.</div>
            </div>
            <div className="rounded-xl bg-secondary p-2">
              <div className="text-lg font-bold text-foreground">{recipe.nutrition.protein}г</div>
              <div className="text-[10px] text-muted-foreground">белок</div>
            </div>
            <div className="rounded-xl bg-secondary p-2">
              <div className="text-lg font-bold text-foreground">{recipe.nutrition.carbs}г</div>
              <div className="text-[10px] text-muted-foreground">углев.</div>
            </div>
          </div>
          ...
          {recipe.brainNote && (
            <div className="rounded-xl bg-brain/10 p-3 flex gap-2">
              ...
              <div>
                <div className="text-xs font-semibold text-brain uppercase">Для шахматиста</div>
          ...
          <section>
            <h3 className="font-semibold text-lg mb-2">Ингредиенты на {recipe.servings} порции</h3>
          ...
          <section>
            <h3 className="font-semibold text-lg mb-2">Приготовление</h3>
